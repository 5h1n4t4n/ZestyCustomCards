...
function s.thcon(e,tp,eg,ep,ev,re,r,rp)
	-- Lấy quái thú được trang bị (thử lấy từ GetEquipTarget, nếu chưa có thì lấy từ eg)
	local ec=e:GetHandler():GetEquipTarget() or eg:GetFirst()
	return ec and ec:IsSetCard(SET_RISING_HERO)
end

function s.thfilter(c)
	-- Tìm quái thú "Rising Unit" (0xa63) từ Deck
