...
function s.initial_effect(c)
	...
	-- Quick Effect: Discard từ tay -> Quái "HERO" không bị phá hủy bởi chiến đấu trong lượt này
...
function s.indtg(e,c)
	-- Bảo vệ tất cả quái thuộc chuỗi HERO (bao gồm cả Rising HERO)
