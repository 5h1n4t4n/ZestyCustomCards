...
s.listed_names={46232525, 74677422} -- Hermos (46232525), Red-Eyes Black Dragon (74677422)
s.listed_series={0x3b}
s.material={74677422} -- Khai báo để Scarlet Claw nhận diện là Material
...
function s.splimit(e,se,sp,st)
	-- Sửa: Cho phép gọi bởi lá 46232525 HOẶC các lá có liên quan đến Hermos
	return se and (se:GetHandler():IsCode(46232525) or se:GetHandler():ListsCode(46232525))
end
...
function s.sptg(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then 
		return Duel.GetLocationCountFromEx(tp,tp,nil,TYPE_FUSION)>=2
