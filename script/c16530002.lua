-- ============================================================
-- Card Name: Advance Cyberdark Horn
-- Passcode : 16530002
-- Type     : Monster / Effect
-- Attribute: DARK
-- Level    : 4
...
-- Effect 2: If Normal or Special Summoned: Send 1 "Cyberdark" card
--           from Deck to GY.
-- You can only use each effect of "Advance Cyberdark Horn" once per turn.
-- ============================================================
